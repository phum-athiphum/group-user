...
describe('groupByDepartment', () => {
  ...
  it('should group users by department with correct gender count, age range, hair color count, and postal codes', () => {
    const result = groupByDepartment(mockData);
  ...
  it('should handle an empty data array by returning an empty object', () => {
